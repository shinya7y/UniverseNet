...
class NightOwlsDataset(CustomDataset):
    ...
    def evaluate(self,
        ...
        for metric in metrics:
            ...
            # evaluate NightOwls metrics
            # TODO output results other than pedestrian simultaneously
            nocoEval = NightOwlsCOCOeval(cocoGt, cocoDt, iou_type)
            nocoEval.params.catIds = self.cat_ids
            nocoEval.params.imgIds = self.img_ids
            nocoEval.evaluate(id_setup)
            nocoEval.accumulate()
            nocoEval.summarize(id_setup)
            ...
            if metric == 'proposal':
                ...
                if classwise:  # Compute per-category AP
                    ...
                    for idx, catId in enumerate(self.cat_ids):
                        ...
                        t = np.where(cocoEval.params.iouThrs == 0.5)[0]
                    ...
                    headers = ['category', 'AP 0.5'] * (num_columns // 2)
