    ...
    def forward(ctx,
        ...
        if not input.is_cuda:
            ...
            deform_conv_ext.deform_conv_forward(
                ...
                ctx.dilation[0], ctx.groups, ctx.deform_groups,
                cur_im2col_step)
        return output
        ...
        if not grad_output.is_cuda:
            ...
            if ctx.needs_input_grad[2]:
                ...
                deform_conv_ext.deform_conv_backward_parameters(
                    ...
                    weight.size(2), ctx.stride[1], ctx.stride[0],
                    ctx.padding[1], ctx.padding[0], ctx.dilation[1],
                    ctx.dilation[0], ctx.groups, ctx.deform_groups, 1,
                    cur_im2col_step)
...
modulated_deform_conv2d = ModulatedDeformConvFunction.apply
...
@CONV_LAYERS.register_module(name='DCNmmd')
...
@CONV_LAYERS.register_module(name='DCNv2mmd')
