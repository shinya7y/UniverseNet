...
from ..utils.convmlp.modules import BasicStage, ConvStage
from ..utils.convmlp.tokenizer import ConvTokenizer
...
def _convmlp(arch, pretrained, progress, classifier_head, blocks, dims,
             mlp_ratios, *args, **kwargs):
    model = ConvMLP(
        blocks=blocks,
        dims=dims,
...
def convmlp_s(pretrained=False,
              progress=False,
              classifier_head=True,
              *args,
              **kwargs):
...
def convmlp_m(pretrained=False,
              progress=False,
              classifier_head=True,
              *args,
              **kwargs):
...
def convmlp_l(pretrained=False,
              progress=False,
              classifier_head=True,
              *args,
              **kwargs):
