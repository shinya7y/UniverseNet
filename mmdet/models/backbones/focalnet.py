...
from mmcv_custom import load_focalnet_checkpoint
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self,
        ...
        if use_conv_embed:
            # if we choose to use conv embedding, then we treat the stem and
            # non-stem differently
            if is_stem:
                kernel_size = 7
                padding = 3
                stride = 4
